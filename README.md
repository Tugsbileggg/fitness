...
Ирээдүйн үйлчлүүлэгчид **"Фитнес хайх"** хэсгээс өөрт ойр фитнесийн үнэ, цаг, байршлыг харна.
...
| Дүр | Юу хийх вэ |
|---|---|
| **Фитнесийн менежер** | Хяналтын самбар (дуусах гэж буй / дууссан, орлого), үйлчлүүлэгч, багш (имэйлээр урих), эрхийн багц, төлбөр (хөнгөлөлт, сунгалт, хүчингүй болгох), тохиргоо, платформын эрх, **нийтийн танилцуулга** (байршил, зураг, цаг, үйлчилгээ) |
| **Багш** | Үйлчлүүлэгч харах, нэмэх, засах, төлбөр бүртгэх, "Мэдэгдсэн" тэмдэглэх. Орлого, төлбөрийн түүх, багц, тохиргоо **харахгүй** |
| **Платформын админ** | Бүх фитнесийн төлөв, үйлчлүүлэгчийн *тоо*, баталгаажуулах (= "Фитнес хайх"-д гаргах), түр зогсоох, туршилт сунгах, платформын төлбөр бүртгэх, тарифууд, орлого (MRR) |
| **Хэн ч (нэвтрэхгүй)** | `/gyms`: фитнес хайх, дүүргээр шүүх, "Ойролцоох" (байршлаар), газрын зураг. `/gyms/[slug]`: фитнесийн хуудас |

Үйлчлүүлэгч системд нэвтрэхгүй. Бүх интерфэйс монгол хэлээр, утсан дээр бүрэн ажиллана.
Газрын зураг: OpenStreetMap + Leaflet (API түлхүүргүй).
...
| `gym.zaisan@demo.test`, `gym.tsetseg@demo.test`, … | "Фитнес хайх"-ийн 7 жишээ фитнесийн менежерүүд (`scripts/demo-gyms.ts`) |
...
"Фитнес хайх"-д 8 фитнес харагдана (Хүчит + 7 жишээ, УБ-ын 6 дүүрэг, Дархан, Эрдэнэт). "Эрч хүч" нь танилцуулгаа
нийтэлсэн ч баталгаажаагүй: менежерийн "хүлээж байна" төлөв ба админы баталгаажуулах урсгалыг туршихад.
...
| `pnpm db:types` | DB-ээс TypeScript төрөл үүсгэх (`src/types/database.types.ts`). Алдаа гарвал файлыг өөрчлөхгүй |
| `pnpm db:seed` | Туршилтын өгөгдөл (зөвхөн локал) |
| `pnpm admin:create <имэйл> "<нууц үг>"` | Платформын админ үүсгэх |
| `pnpm cloud:plans` | Платформын тарифуудыг cloud-д үүсгэх (`--dry-run` дэмжинэ) |
| `pnpm cloud:demo` | "Фитнес хайх"-ийн жишээ фитнесүүдийг cloud-д үүсгэх (`--dry-run`, `--unpublish`, `--publish`) |
...
- **"Фитнес хайх"-д гарах.** Менежер танилцуулгаа нийтэлсэн + админ баталгаажуулсан + платформын эрх
  `trial`/`active`. Эрх дуусвал эсвэл түр зогсоовол автоматаар нуугдана. Нийтлэхэд дүүрэг, газрын зураг дээрх
  байршил заавал. Үнэ эрхийн багцаас автоматаар (менежер нууж болно).
...
- **Нийтийн хуудас.** Нэвтрээгүй хүн `gym_profiles`-ийг шууд уншихгүй. `list_public_gyms` / `get_public_gym`
  RPC нь зөвхөн жагсаалтад орсон фитнесийн нийтийн баганыг буцаана (тест баганын жагсаалтыг тулгадаг).
  Хэрэглэгчийн байршил хөтөч дээр л ашиглагдана, серверт очихгүй. Нийтэд харагдах утсыг менежер тусад нь оруулна
  (бүртгэлийн утас автоматаар ил гарахгүй).
...
5. **Тарифууд.** `pnpm cloud:plans` — `scripts/platform-plans.ts` доторх багцуудыг cloud-д үүсгэнэ
   (`--dry-run`-аар урьдчилж харна). Cloud дээр `pnpm db:seed` ажиллахгүй тул тарифыг эндээс тавина.
   **Тарифгүй бол нүүр хуудасны "Үнийн санал" хэсэг хоосон гарна.** Дараа нь админ `/admin/plans`
   дээрээс нэр, үнэ, хязгаарыг засна.
6. **Жишээ фитнесүүд (заавал биш).** `pnpm cloud:demo` — "Фитнес хайх" хоосон харагдахгүйн тулд 7 зохиомол
   фитнес үүсгэнэ (утасгүй, нэвтрэх эрхгүй). Бодит фитнесүүд нэгдмэгц `pnpm cloud:demo --unpublish`.
7. **Шинэ хувилбар бүрт.** Шинэ migration нэмэгдсэн бол `pnpm cloud:push`-ийг deploy-оос өмнө ажиллуулна.
...
- **Vercel дээр бүх хуудас "Internal Server Error".** Орчны хувьсагч дутуу байна. `src/proxy.ts`
  ...
  монголоор харна.
- **Локал дээр лого/зураг оруулахад 500 (`42P10`).** `pnpm cloud:link`-ийн дараа CLI нь cloud-ийн storage хувилбарыг
  `supabase/.temp/`-д бичдэг. Локал storage-api хуучин хэвээр байвал схемтэй зөрнө. `pnpm db:stop && pnpm db:start`
  хийж контейнеруудыг шинэ хувилбараар үүсгэнэ.
- **Docker "backend crashed … sailor-ingest.sock / engine.sock: rename … cannot be accessed".** Компьютер Docker-ийг
  хаалгүй унтарсны дараа хуучин socket файл үлддэг. "Reset to factory defaults" **бүү** дар — тусалхгүй. Docker Desktop-ийг
  хаагаад (Quit) `%LOCALAPPDATA%\Docker\run` ба `%LOCALAPPDATA%\docker-secrets-engine` хавтсуудын нэрийг сольж (жишээ нь
  `run.old`), дахин асаана. Docker шинээр үүсгэнэ.
